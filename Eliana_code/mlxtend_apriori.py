...
# Quick guide to legal: https://tldrlegal.com/license/bsd-3-clause-license-(revised)
# Rest of repository: https://github.com/rasbt/mlxtend/blob/master/mlxtend/frequent_patterns/apriori.py
